...
var file_sf_substreams_sink_sql_v1_services_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xbf, 0x03, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1e,
	...
	,
	...
	0x0d, 0x50, 0x47, 0x57, 0x65, 0x62, 0x46, 0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x12, 0x18,
...
var file_sf_substreams_sink_sql_v1_services_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_sf_substreams_sink_sql_v1_services_proto_goTypes = []interface{}{
	...
	(*HasuraFrontend)(nil),       // 2: sf.substreams.sink.sql.v1.HasuraFrontend
	(*PostgraphileFrontend)(nil), // 3: sf.substreams.sink.sql.v1.PostgraphileFrontend
	(*PGWebFrontend)(nil),        // 4: sf.substreams.sink.sql.v1.PGWebFrontend
}
var file_sf_substreams_sink_sql_v1_services_proto_depIdxs = []int32{
	...
	2, // 1: sf.substreams.sink.sql.v1.Service.hasura_frontend:type_name -> sf.substreams.sink.sql.v1.HasuraFrontend
	3, // 2: sf.substreams.sink.sql.v1.Service.postgraphile_frontend:type_name -> sf.substreams.sink.sql.v1.PostgraphileFrontend
	4, // 3: sf.substreams.sink.sql.v1.Service.pgweb_frontend:type_name -> sf.substreams.sink.sql.v1.PGWebFrontend
